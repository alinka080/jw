...
public class CreateGemstoneWindowController implements Initializable {
    ...
    void BtnOkAction(ActionEvent event) throws IOException {
        ...
        Manager.MessageBox("Камень", "Удачно!", "Данные успешно сохранены!", Alert.AlertType.INFORMATION);
        Manager.gemstoneServices.save(Manager.currentGemstone);
    }
