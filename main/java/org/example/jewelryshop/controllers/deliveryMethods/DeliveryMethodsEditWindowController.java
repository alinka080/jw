...
public class DeliveryMethodsEditWindowController implements Initializable {
    ...
    void BtnOkAction(ActionEvent event) throws IOException {
        ...
        Manager.deliveryMethodServices.update(Manager.currentDeliveryMethods);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        TextFieldTitle.setText(Manager.currentDeliveryMethods.getTitle());
        TextFieldDescription.setText(Manager.currentDeliveryMethods.getDescription());
        TextFieldCost.setText(Manager.currentDeliveryMethods.getCost().toString());
    }
}
